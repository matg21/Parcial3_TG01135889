...
<div class="d-flex justify-content-end mb-5"><a href="{{route('profesor.create')}}" class="btn btn-primary"><ion-icon name="add-circle-outline"></ion-icon></a></div>
...
<a href="{{route('profesor.show', $profesor->idprofesor)}}" class="btn btn-warning"><ion-icon name="eye-outline"></ion-icon></a>
